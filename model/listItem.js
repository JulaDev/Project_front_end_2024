...
snackItems = new ProductItemsModel("snack_items");
dessertItems = new ProductItemsModel("dessert_items");
meatItems = new ProductItemsModel("meat_items");
seafoodItems = new ProductItemsModel("seafood_items");
fruitItems = new ProductItemsModel("fruit_items");
vegetableItems = new ProductItemsModel("vegetable_items");
